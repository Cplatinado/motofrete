...
<body>
    ...
    <div class="container-fluid">
        <div class="row baner align-items-end justify-content-center text-center ">
            <div class="container">
            ...
            <div class="col-sm-3   menu1">
                <h4 class="banertitulo">Valores</h4>
                <div class="dropdown-divider"></div>
                <p class="text-left "> Os nossos valores São o mais em conta da região</p>
                <a href="#" class="btn btn-success align-items-end"> Pesquisar bairros</a>
            </div>
            <div class="col-sm-4 menu2">
                <h4 class="banertitulo">Contato</h4>
                <div class="dropdown-divider"></div>
                <p class="text-left "> Quer solicitar nossos serviços ?,
                    fazer alguma parceria ? entre em contato com nosco.</p>
                <a href="#" class="btn btn-success align-items-end"> Contato</a>
            </div>
            <div class="col-sm-3 menu3">
                <h4 class="banertitulo">Horario de fucionamento</h4>
                <div class="dropdown-divider"></div>
                <p class="text-left "> Trabalhamos diaramente das 8:00 Hs até as 24:00 Hs </p>
            </div>
        </div>
    </div>
